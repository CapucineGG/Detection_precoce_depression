...
plt.title(f'Courbe ROC Comparaison des modèles : students')
plt.legend()
plt.show()
...
plt.title('Méthode du coude : students')
plt.show()
...
corr_matrix = df_students.corr().round(2)
...
X = df_students[selected_features.index]
y = df_students['Depression']
...
plt.title('Feature Importance (Random Forest) : students')
plt.show()
...
disp.plot()
plt.title('Matrice de confusion : students')
plt.show()
...
plt.title('Courbe ROC : students')
plt.legend(loc="lower right")
plt.show()

print(classification_report(y_test, y_pred))

#joblib.dump(best_pipeline, f'lr_students.joblib')